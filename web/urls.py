...
urlpatterns += i18n_patterns(
    ...
    # Gathering URLs
    path("gatherings/", gathering_list, name="gathering_list"),
    path("gatherings/create/", create_gathering, name="create_gathering"),
    path("gatherings/mine/", my_gatherings, name="my_gatherings"),
    path("gatherings/<slug:slug>/", gathering_detail, name="gathering_detail"),
    path("gatherings/<slug:slug>/edit/", edit_gathering, name="edit_gathering"),
    path("gatherings/<slug:slug>/delete/", delete_gathering, name="delete_gathering"),
    path("gatherings/<slug:slug>/register/", register_for_gathering, name="register_for_gathering"),
    path(
        "gatherings/<slug:slug>/cancel-registration/",
        cancel_gathering_registration,
        name="cancel_gathering_registration",
    ),
    path("gatherings/<slug:slug>/manage/", manage_gathering, name="manage_gathering"),
    # Payment URLs
    path(
